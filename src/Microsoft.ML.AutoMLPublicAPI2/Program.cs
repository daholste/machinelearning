...
namespace Microsoft.ML.AutoMLPublicAPI2
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var autoMlResult = mlContext.BinaryClassification.Auto(trainData, validationData, 5, preprocessor);
            ...
            var predFunction = savedModel.MakePredictionFunction<UciAdultInput, UciAdultOutput>(mlContext);
