...
using Microsoft.ML.Runtime.TlcTesting.Inference;
...
namespace Microsoft.ML.Runtime.TlcTesting.Inference
{
    /// <summary>
    ...
    public sealed class InferSchemaCommand : ICommand
    {
        ...
        public void RunCore(IChannel ch)
        {
            ...
            try
            {
                json = JsonConvert.SerializeObject(groupingResult, Newtonsoft.Json.Formatting.Indented);
            }
            catch
            {
